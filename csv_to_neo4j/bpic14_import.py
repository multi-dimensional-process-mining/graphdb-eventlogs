...
model_entities = [['CIName','CINameAff', 'WHERE EXISTS(e.CINameAff)'], # Original Case ID
                   ['Incident','IncidentID', 'WHERE EXISTS(e.IncidentID)'],
                   ['Interaction','InteractionID', 'WHERE EXISTS(e.InteractionID)'],
