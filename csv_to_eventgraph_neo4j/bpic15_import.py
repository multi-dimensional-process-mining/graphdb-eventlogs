...
model_entities = [['Application','cID', 'WHERE e.cID IS NOT NULL'], # Original Case ID
                  ['Case_R', 'resource', 'WHERE e.resource IS NOT NULL'],
                  ['Responsible_actor', 'Responsible_actor', 'WHERE e.Responsible_actor IS NOT NULL'],
                  ['monitoringResource', 'monitoringResource', 'WHERE e.monitoringResource IS NOT NULL']] 
...
model_relations = [['Same_Resource','Case_R','Responsible_actor','Responsible_actor'],
                   ['Same_Resource','Case_R','monitoringResource','monitoringResource']]
